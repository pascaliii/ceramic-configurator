...
export const Cup = ({ clay, glaze }) => {
  const { nodes, materials } = useGLTF('./models/Model_Cup_2023_09_03.gltf')
  const ref = useRef()
  ...
  const createNewMaterial = () => {
    ...
    materialTexture.colorMap.repeat.set(2, 2)
    materialTexture.normalMap.repeat.set(2, 2)
    materialTexture.displacementMap.repeat.set(2, 2)
    materialTexture.aoMap.repeat.set(2, 2)
    materialTexture.roughnessMap.repeat.set(2, 2)
